...
concepts.push({
  ...concepts[14],
  code: "A11",
  name: "Reference silhouette",
  crystalRefinement: 4,
  material: "Familiar silhouette · simplified internal facets",
  description:
    "A silhouette close to the reference: a broad leaning crystal, small left fragment, and compact blue cluster around its foot. The interior is reduced to larger connected facets, with warm ivory/peach on the main body and blue on the base. A6 remains the baseline.",
  hsr: "Three connected crystal forms, with shared facet edges and a clear front-to-side turn.",
});
export const shapes = {
  angular: [
