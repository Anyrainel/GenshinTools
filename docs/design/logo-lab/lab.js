...
$("concepts").innerHTML = [0]
  .map(
    (family) =>
      `<section class="family"><div class="family-heading"><h2>${family === 0 ? "A / Option 1 silhouette" : "B / Option 4 silhouette"}</h2><span>A6 baseline · A11 reconstructed crystal</span></div><div class="family-grid">${[
        10, 15,
      ]
        .map((i) => {
