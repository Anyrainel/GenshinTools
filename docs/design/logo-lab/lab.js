...
$("concepts").innerHTML = [0]
  .map(
    (family) =>
      `<section class="family"><div class="family-heading"><h2>${family === 0 ? "A / Option 1 silhouette" : "B / Option 4 silhouette"}</h2><span>A6 baseline · A9 geometry · A10 light and color</span></div><div class="family-grid">${[
        10, 13, 14,
      ]
        .map((i) => {
