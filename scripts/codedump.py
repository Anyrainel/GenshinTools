...
def write_data(
    ...
    details: bool = True,
    enemy_data: list[EnemyOutput] | None = None,
) -> None:
...
def _write_resources_ts(
    ...
    details: bool = True,
    enemy_data: Sequence[EnemyOutput] = (),
) -> None:
    ...
    exports: list[tuple[str, str, Sequence[Any], bool]] = [
        ...
        ("enemies", "EnemyResource[]", enemy_data, False),
    ]
    ...
    with open(path, "w", encoding="utf-8") as f:
        ...
        f.write(
            ...
            "EnemyResource, WeaponResource, WeaponTypeResource } from './types';\n\n"
        )
...
def download_all_images(
    ...
    enemies: list[MatchedItem[EnemySource]] | None = None,
) -> None:
...
def main():
    ...
    print(
        ...
        f"Artifact={args.artifact}, Enemy={args.enemy}, Enka={args.enka}, Details={args.details}"
    )
    if not args.details:
    ...
    enemy_data = existing_resources.get("enemies", [])
    ...
    matched_arts = []
    matched_weaps = []
    matched_enemies: list[MatchedItem[EnemySource]] = []
    new_elements = None
    ...
    if args.character or args.artifact or args.weapon or args.enemy:
    ...
    if updated_types or args.half_set:
        ...
        download_all_images(
            ...
            new_elements,
            new_weapon_types,
            enemies=matched_enemies or None,
        )
