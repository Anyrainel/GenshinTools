...
# Typedefs from hoyolab.py for type hinting
...
def enrich_character_data_with_fandom(
    ...
    for char in characters_en:
        ...
        if fandom_char:
            ...
            print(f"Enriched {char['name']} from Fandom")
        else:
            ...
            enriched_characters.append(enriched_char)
            print(f"Using defaults for {char['name']} (Not found in Fandom)")
...
def save_typescript_data(
        ...
        character_data.append(
            {
                ...
                "weapon": char_en.get("weapon", "Sword"), # type: ignore
                "region": char_en.get("region", "None"), # type: ignore
                "releaseDate": char_en.get("releaseDate", "2020-09-28"), # type: ignore
    ...
    matched_artifacts = match_items_by_image_url(
        # type: ignore
        artifacts_en, artifacts_zh, "artifact"
    )
    ...
    i18n_data: Dict[str, Dict[str, Any]] = {"characters": {}, "artifacts": {}, "weapons": {}}
    ...
    with open(resources_path, "w", encoding="utf-8") as f:
        ...
        f.write(
            "import { Character, ArtifactSet, ElementResource, Weapon, ArtifactHalfSet, WeaponTypeResource } from './types';\n\n"
        )
...
def download_all_images(
    ...
    if weapon_types:
        ...
        for weapon_type in weapon_types:
            filename = os.path.join(
                project_root, "public", "weapontype", f"{weapon_type['name'].lower()}.png"
            )
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            save_typescript_data(
                characters_en, characters_zh, 
                artifacts_en, artifacts_zh, 
                weapons_en, weapons_zh,
                fandom_data, elements, weapon_types
            )
