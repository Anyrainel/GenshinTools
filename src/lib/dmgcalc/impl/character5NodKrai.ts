...
class Linnea extends CharacterBase {
  ...
  readonly buffs = [
    ...
    // Without LC, 18 total stacks. Million-ton consumes 5 (C6: 10). Remaining:
    // C0-C5: 13 stacks (1 per hit), C6: 8 stacks (2 per hit = 4 hits)
          ...
          new ScalingBuff(
            {
              ...
              ...(this.teamMeta.hasReaction("lunarCrystallize")
                ? {}
                : { maxStacks: this.constellation >= 6 ? 4 : 13 }),
            },
            { receiver: "team", filter: { reactions: ["lunarCrystallize"] } },
            [],
            "def",
